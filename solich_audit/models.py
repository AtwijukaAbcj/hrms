...
def pre_create_solich_audit_log(sender, instance, *args, **kwargs):
    """
...
def post_create_solich_audit_log(sender, instance, *_args, **kwargs):
    """
...
class AuditModelConfig(SolichModel):
    """
