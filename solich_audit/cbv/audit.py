...
from solich_audit.filters import AudiTagFilter
...
@method_decorator(permission_required("solich_audit.view_audittag"), name="dispatch")
class AudiTagsList(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("solich_audit.view_audittag"), name="dispatch")
class AuditTagsNavView(SolichNavView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("solich_audit.add_audittag"), name="dispatch")
class AuditTagCreateForm(SolichFormView):
    """
