...
class RecruitmentList(SolichListView):
    """
...
class RecruitmentNav(SolichNavView):
    """
    For nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class RecruitmentNewSkillForm(SolichFormView):
    """
...
class RecruitmentForm(SolichFormView):
    """
    Form View
    """
...
@method_decorator(login_required, name="dispatch")
class AddCandidateFormView(SolichFormView):
    """
...
class RecruitmentFormDuplicate(SolichFormView):
    """
    Duplicate form view
    """
...
class RecruitmentDetailView(SolichDetailedView):
    """
    detail view of page
    """
