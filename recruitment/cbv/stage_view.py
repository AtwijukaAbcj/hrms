...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="recruitment.view_stage"), name="dispatch")
class StageList(SolichListView):
    """
    List view of stage
    """
    ...
    def get_queryset(self):
        ...
        queryset = (
            ...
            .prefetch_related(
                ...
                # (SolichCompanyManager), but prefetch_related builds its batch
...
class StageFormView(SolichFormView):
    """
    Form View
    """
...
class StageDuplicateForm(SolichFormView):
    """
    Duplicate form view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="recruitment.view_stage"), name="dispatch")
class StageDetailView(SolichDetailedView):
    """
    detail view of page
    """
