...
from solich_views.generic.cbv.views import SolichDetailedView, SolichFormView
...
class QuestionFormView(SolichFormView):
    """
...
class QuestionDuplicateFormView(SolichFormView):
    """
...
class SurveyTemplateFormView(SolichFormView):
    """
...
class RecruitmentSurveyDetailView(SolichDetailedView):
    """
