...
class ListCandidates(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter(perm="recruitment.view_candidate"), name="dispatch")
class CardCandidates(SolichCardView):
    """
    For card view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter(perm="recruitment.view_candidate"), name="dispatch")
class CandidateNav(SolichNavView):
    """
    For nav bar
    """
...
class CandidateDetail(SolichDetailedView):
    """
    Candidate detail
    """
...
class ToSkillZoneFormView(SolichFormView):
    """
    Form View
    """
...
class RejectReasonFormView(SolichFormView):
    """
    Form View
    """
