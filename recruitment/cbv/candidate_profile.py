...
from solich_views.generic.cbv.views import SolichListView, SolichProfileView
...
class CandidateProfileView(SolichProfileView):
    """
...
class CandidateProfileTasks(SolichListView):
    """
