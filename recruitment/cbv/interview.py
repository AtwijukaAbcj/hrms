...
class InterviewNavView(SolichNavView):
    """
    nav bar of the page
    """
...
class InterviewLIstView(SolichListView):
    """
...
class InterviewDetailView(SolichDetailedView):
    """
    detailed view
    """
...
class InterviewForm(SolichFormView):
    """
    form view
    """
