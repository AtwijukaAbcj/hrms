...
from solich_views.generic.cbv.views import SolichListView
...
class SkillZoneStatusList(SolichListView):
    """
...
class CandidateOnOnboardList(SolichListView):
    """
...
class CurrentHiringList(SolichListView):
    """
...
class OnGoingRecruitmentList(SolichListView):
    """
