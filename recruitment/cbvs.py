...
class LinkedinSettingSectionView(views.SolichSectionView):
    """
...
class LinkedInSettingNavView(views.SolichNavView):
    """
...
class LinkedInAccountFormView(views.SolichFormView):
    """
    LinkedInForm View
    """
...
class LinkedInSettingListView(views.SolichListView):
    """
