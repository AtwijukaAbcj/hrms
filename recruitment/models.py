...
class Candidate(SolichModel):
    ...
    def options(self):
        ...
        emp_list = SolichUser.objects.filter(username__in=mails).values_list(
            "email", flat=True
        )
...
class CandidateDocumentRequest(SolichModel):
...
class CandidateDocument(SolichModel):
...
class LinkedInAccount(SolichModel):
