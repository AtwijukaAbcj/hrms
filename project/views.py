...
def create_task_in_project(request, project_id):
    ...
    if not project:
        return SolichRedirect(request, message=_("Project not found"))
...
def update_timesheet_task(request, timesheet_id):
    ...
    if not timesheet:
        return SolichRedirect(request, message=_("Timesheet not found"))
...
def delete_project_stage(request, stage_id):
    ...
    stage = ProjectStage.objects.filter(id=stage_id).first()
    if not stage:
        return SolichRedirect(request, message=_("Project stage not found"))
...
def time_sheet_delete(request, time_sheet_id):
    ...
    Returns:
        SolichRedirect: A redirect response to the timesheet view page.
    """
