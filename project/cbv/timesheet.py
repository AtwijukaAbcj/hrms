...
class TimeSheetNavView(SolichNavView):
    """
    Nav bar
    """
...
class TimeSheetList(SolichListView):
    """
...
class TimeSheetFormView(SolichFormView):
    """
...
class TimeSheetCardView(SolichCardView):
    """
    For card view
    """
...
class TimeSheetDetailView(SolichDetailedView):
    """
