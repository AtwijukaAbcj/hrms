...
class ProjectStage(SolichModel):
    """
    ProjectStage model
    """
    ...
    objects = SolichCompanyManager("project__company_id")
...
class TimeSheet(SolichModel):
    ...
    objects = SolichCompanyManager("project_id__company_id")
