...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("leave.view_leaverequest"), name="dispatch")
class LeaveRequestsListView(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("leave.view_leaverequest"), name="dispatch")
class LeaveRequestsNavView(SolichNavView):
    """
    nav bar
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("leave.view_leaverequest"), name="dispatch")
class LeaveRequestsDetailView(SolichDetailedView):
    """
    detail view of page
    """
...
class LeaveRequestFormView(SolichFormView):
    """
    form view
    """
