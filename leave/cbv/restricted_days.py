...
@method_decorator(login_required, name="dispatch")
class RestrictedDaysList(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
class RestrictedDaysNav(SolichNavView):
    """
    Nav bar
    """
...
class RestrictedDaysFormView(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class RestrictedDaysDetailView(SolichDetailedView):
    """
    detail view of page
    """
