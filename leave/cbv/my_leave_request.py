...
@method_decorator(login_required, name="dispatch")
class MainParentListView(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
class MyLeaveRequestNavView(SolichNavView):
    """
    nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class MyLeaveRequestDetailView(SolichDetailedView):
    """
    detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class MyLeaveRequestForm(SolichFormView):
    """
    form view
    """
...
@method_decorator(login_required, name="dispatch")
class MyLeaveRequestSingleForm(SolichFormView):
    """
