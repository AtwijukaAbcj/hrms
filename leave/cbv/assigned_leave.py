...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("leave.view_availableleave"), name="dispatch")
class AssignedleaveList(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("leave.view_availableleave"), name="dispatch")
class AssignedLeaveNavView(SolichNavView):
    """
    navbar of the page
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("leave.view_availableleave"), name="dispatch")
class AssignedLeaveDetailView(SolichDetailedView):
    """
    detail view
    """
...
# not done
class AssignedLeaveFormView(SolichFormView):
    """
    form view
    """
