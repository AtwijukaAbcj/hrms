...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="leave.view_leavetype"), name="dispatch")
class LeaveTypeListView(SolichListView):
    """
    list view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="leave.view_leavetype"), name="dispatch")
class LeaveTypeNavView(SolichNavView):
    """
    navbar
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="leave.view_leavetype"), name="dispatch")
class LeaveTypeDetailView(SolichDetailedView):
    """
    detail view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="leave.view_leavetype"), name="dispatch")
class LeaveTypeCardView(SolichCardView):
    """
    card view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="leave.view_leavetype"), name="dispatch")
class LeaveTypeAssignForm(SolichFormView):
    """
    form view
    """
