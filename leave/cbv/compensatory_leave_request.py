...
@method_decorator(login_required, name="dispatch")
@method_decorator(is_compensatory_leave_enabled(), name="dispatch")
class CompensatoryListView(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(is_compensatory_leave_enabled(), name="dispatch")
class CompensatoryNavView(SolichNavView):
    """
    nav bar
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(is_compensatory_leave_enabled(), name="dispatch")
class CompensatoryLeaveTabView(SolichTabView):
    """
    tabview of the page
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(is_compensatory_leave_enabled(), name="dispatch")
class CompensatoryGenericDetailView(SolichDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(is_compensatory_leave_enabled(), name="dispatch")
class CompensatoryForm(SolichFormView):
    """
    for view
    """
...
# class CompensatoryRejectForm(SolichFormView):
#     """
#     for view
#     """
