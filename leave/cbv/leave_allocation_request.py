...
@method_decorator(login_required, name="dispatch")
class LeaveAllocationRequestList(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
class LeaveAllocationRequestTab(SolichTabView):
    """
    Tab View
    """
...
@method_decorator(login_required, name="dispatch")
class LeaveAllocationRequestNav(SolichNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class LeaveAllocationRequestDetailView(SolichDetailedView):
    """
    detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class LeaveAllocationRequestFormView(SolichFormView):
    """
    Form View
    """
...
@method_decorator(login_required, name="dispatch")
class LeaveAllocationBulkFormView(SolichFormView):
    """
