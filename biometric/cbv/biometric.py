...
class BiometricNavBar(SolichNavView):
    """
    nav bar of the page
    """
...
class BiometricCardView(SolichCardView):
    """
...
class BiometricFormView(SolichFormView):
    """
...
class BiometricSheduleForm(SolichFormView):
    """
