...
@method_decorator(login_required, name="dispatch")
class MeetingsList(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
class MeetingsNav(SolichNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class MeetingsDetailedView(SolichDetailedView):
    """
    detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class MeetingsFormView(SolichFormView):
    """
    Form View
    """
...
@method_decorator(login_required, name="dispatch")
class MeetingResponseFormView(SolichFormView):
    """
    Form View
    """
