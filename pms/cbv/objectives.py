...
@method_decorator(login_required, name="dispatch")
class ObjectivesList(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
class ObjectivesTab(SolichTabView):
    """
    Tab View
    """
...
@method_decorator(login_required, name="dispatch")
class ObjectivesNav(SolichNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class CreateEmployeeObjectiveForm(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class CreateObjectiveFormView(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class AddAssigneesFormView(SolichFormView):
    """
    ...
    def dispatch(self, request, *args, **kwargs):
        ...
        if not obj_id:
            return SolichRedirect(request, message=_("Objective ID is missing"))

        self.object = Objective.objects.filter(pk=obj_id).first()

        if not self.object:
            return SolichRedirect(request, message=_("Invalid Objective"))
...
@method_decorator(login_required, name="dispatch")
class CreateEmployeeKeyResultFormView(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class EmployeeObjectiveDetailView(SolichDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class EmployeeObjectiveKeyResultDetailListView(SolichListView):
    """
    List view of the page
    """
...
class EKRTab(EmployeeObjectiveKeyResultDetailListView):
    ...
    def get_queryset(self, queryset=None, filtered=False, *args, **kwargs):
        self.queryset = SolichListView.get_queryset(
