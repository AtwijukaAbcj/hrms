...
from solich_views.generic.cbv.history import SolichHistoryView
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter(perm="pms.view_keyresult"), name="dispatch")
class KeyResultNavView(SolichNavView):
    """
    navbar of the page
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter(perm="pms.view_keyresult"), name="dispatch")
class KeyResultsListView(SolichListView):
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter(perm="pms.view_keyresult"), name="dispatch")
class KeyResultCardView(SolichCardView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter(perm="pms.view_keyresult"), name="dispatch")
class KeyResultsDetailedView(SolichDetailedView):
    """
    Detail View
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter(perm="pms.view_keyresult"), name="dispatch")
class KeyResultFormView(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class EKRHistory(SolichHistoryView):
    """
    EKR History
    """
