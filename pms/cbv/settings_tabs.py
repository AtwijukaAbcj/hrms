...
from solich_views.generic.cbv.views import SolichTabView, TemplateView
...
@method_decorator(login_required, name="dispatch")
class PerformanceSettingsTabView(SolichTabView):
    """
...
# this settings tab. This is necessary because SolichTabView keeps every
