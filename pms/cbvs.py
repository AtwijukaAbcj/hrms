...
from solich.decorators import login_required, owner_can_enter, permission_required
...
class BonusPointSettingSectionView(views.SolichSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingNavView(views.SolichNavView):
    """
...
class BonusPointSettingFormView(views.SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("pms.view_bonuspointsetting"), name="dispatch")
class BonusPointSettingListView(views.SolichListView):
    """
...
class EmployeeBonusPointSectionView(views.SolichSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
class EmployeeBonusPointNavView(views.SolichNavView):
    """
    BonusPoint nav view
    """
...
@method_decorator(login_required, name="dispatch")
class EmployeeBonusPointFormView(views.SolichFormView):
    """
    BonusPointForm View
    """
...
@method_decorator(login_required, name="dispatch")
class EmployeeBonusPointListView(views.SolichListView):
    """
    BnusPoint list view
    """
...
@method_decorator(login_required, name="dispatch")
class FeedbackEmployeeFormView(views.SolichFormView):
    """
...
class BulkFeedbackFormView(views.SolichFormView):
    """
    Feedback other employee form View
    """
