...
def key_result_creation(request, obj_id, obj_type):
    ...
    if obj_type == "individual":
        ...
        return SolichRedirect(request, message=_("Invalid parameters"))
    context = {
...
def feedback_update(request, id):
    ...
    context = {"feedback_form": form}
    if feedback_started:
        return SolichRedirect(request, message=_("Ongoing feedback is not editable!."))
...
def feedback_delete(request, id):
    ...
    if request.headers.get("HX-Request"):
        ...
        return response
    return SolichRedirect(request, message=error_message)
...
def question_delete(request, id):
    ...
    return SolichRedirect(request, message=error_msg)
...
def question_template_related_view(request, template_id, **kwargs):
    ...
    solich_views/related_link_registry.py), so it renders as a modal
