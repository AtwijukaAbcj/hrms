...
class Loader(BaseLoader):
    ...
    def _resolve_site(self):
        ...
        if not hasattr(request, "_solich_dbtemplate_site"):
            request._solich_dbtemplate_site = get_site_for_request(request)
        return request._solich_dbtemplate_site
    ...
    def _load_and_store_template(self, template_name, cache_key, site, **params):
        ...
        display_name = f"solich_dbtemplate:{db}:{template_name}:{site_domain}"
