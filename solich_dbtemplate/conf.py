"""
Configuration for solich_dbtemplate.

Reads from Django settings with SOLICH_DBTEMPLATE_* prefix.
...
def get_setting(name, default=None):
    """Get a setting with SOLICH_DBTEMPLATE_ prefix."""
    full_name = f"SOLICH_DBTEMPLATE_{name}"
    return getattr(settings, full_name, default)


# Cache backend name from CACHES (e.g. "default" or "solich_dbtemplate")
