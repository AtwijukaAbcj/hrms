"""
base.py — Main Django settings for Solich
"""
...
MIDDLEWARE = [
    ...
    "solich.solich_middlewares.MethodNotAllowedMiddleware",
    "solich.solich_middlewares.SVGSecurityMiddleware",
    "solich.solich_middlewares.MissingParameterMiddleware",
...
AUTH_USER_MODEL = "solich_auth.SolichUser"
...
# re-parsing it (and re-running solich_dbtemplate's DB-lookup chain) on
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                # Solich dynamic context processors
                ...
                "solich_tour.context_processors.pending_tours_flag",
...
LOCALE_PATHS = [join(BASE_DIR, "solich", "locale")]
...
# Audit logging is opt-in: the solich_audit app registers models explicitly
...
AUTH_LDAP_BIND_DN = env("AUTH_LDAP_BIND_DN", default="cn=admin,dc=solich,dc=com")
...
DEFAULT_LDAP_CONFIG = {
    ...
    "BIND_DN": env("BIND_DN", default="cn=admin,dc=solich,dc=com"),
    "BIND_PASSWORD": env("BIND_PASSWORD", default=""),
    "BASE_DN": env("BASE_DN", default="ou=users,dc=solich,dc=com"),
}
...
# ========================================
# Fail closed when DEBUG=False or SOLICH_ENV=production. Local DEBUG=True
# tutorials keep insecure-but-documented defaults for open-source onboarding.
from solich.settings.security import (  # noqa: E402
    apply_secure_defaults,
    is_production_mode,
    validate_production_secrets,
)

IS_PRODUCTION = is_production_mode(DEBUG, SOLICH_ENV)
