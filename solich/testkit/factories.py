"""Lightweight model factories for Solich TestCase suites."""
...
def make_user(
    ...
    *,
    ...
    email = email or f"{username}@test.solich"
    if is_superuser:
        return SolichUser.objects.create_superuser(
            username=username, email=email, password=password
        )
    return SolichUser.objects.create_user(
        username=username, email=email, password=password
    )
...
def make_employee(
    *,
    ...
    Employee.save() auto-creates a SolichUser when none is set; pass
