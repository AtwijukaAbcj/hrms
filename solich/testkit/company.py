"""Helpers for testing SolichCompanyManager tenancy filtering."""

from __future__ import annotations

from solich.solich_middlewares import get_selected_company, set_selected_company
...
class CompanyFilterTestMixin:
    """
    Set/clear the ContextVar used by ``SolichCompanyManager.get_queryset``.

    Prefer this over mutating model class attributes — current Solich
