"""
solich/inherit/view_registry.py

Registry for the two _inherit modes supported by SolichViewInheritMixin.
...
def register_replacement(parent_cls, ext_cls) -> None:
    ...
    Called immediately when the extension class is defined (via SolichViewInheritMixin).
    """
