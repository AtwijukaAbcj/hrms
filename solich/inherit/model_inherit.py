"""
solich/inherit/model_inherit.py

SolichModelBase — metaclass for SolichModel that enables field and method
...
Usage in an extension app:
    ...
    class AssetExtension(SolichModel):
...
to the extension app via INJECTION_MAP + SolichAutodetector.
"""
...
class SolichModelBase(ModelBase):
    """
    Metaclass for SolichModel.
