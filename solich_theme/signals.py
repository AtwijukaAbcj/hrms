"""
Signals for the solich_theme app
"""

# themes/signals.py
# Define your solich_theme signals here
from django.db.models.signals import post_migrate
from django.db.utils import OperationalError, ProgrammingError
from django.dispatch import receiver

from .models import THEMES_DATA, SolichColorTheme


@receiver(post_migrate)
def create_default_themes(sender, **kwargs):
    """
    Create default color solich_theme after migration
    """
    # Only run for the solich_theme app
    if sender.name != "solich_theme":
        return

    # Check if solich_theme already exist
    try:
        # Table may not exist yet in some migration orders
        if SolichColorTheme.objects.exists():
            return
    ...
    for theme_data in THEMES_DATA:
        try:
            theme, created = SolichColorTheme.objects.get_or_create(
