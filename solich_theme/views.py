...
@method_decorator(
    permission_required("solich_theme.view_solichcolortheme"),
    name="dispatch",
)
class ThemeView(LoginRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["themes"] = SolichColorTheme.objects.all()
        ...
        default_theme = SolichColorTheme.get_default_theme()
...
@method_decorator(
    permission_required("solich_theme.change_solichcolortheme"),
    name="dispatch",
)
class ChangeThemeView(LoginRequiredMixin, View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        try:
            theme = SolichColorTheme.objects.get(pk=theme_id)
        ...
        except SolichColorTheme.DoesNotExist:
    ...
    def _render_themes(self, request, active_theme=None, status=200):
        ...
        themes = SolichColorTheme.objects.all()
        active_company = getattr(request, "active_company", None)
...
@method_decorator(
    permission_required("solich_theme.add_solichcolortheme"),
    name="dispatch",
)
