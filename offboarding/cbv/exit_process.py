...
from solich_views.generic.cbv.kanban import SolichKanbanView
...
class OffboardingStageFormView(SolichFormView):
    """
...
class OffboardingStageAddEmployeeForm(SolichFormView):
    """
    form view for create button
    """
...
class OffboardingCreateFormView(SolichFormView):
    """
...
class OffboardingTaskFormView(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class ExitProcessDetailView(SolichDetailedView):
    """
    detail view
    """
...
class OffboardingPipelineView(SolichSectionView):
    """
...
class OffboardingPipelineNav(SolichNavView):
    """
...
class PipeLineTabView(SolichTabView):
    """
    Pipeline Tab View
    """
...
@method_decorator(login_required, name="dispatch")
class OffboardingKanbanView(SolichKanbanView):
    """
...
@method_decorator(login_required, name="dispatch")
class OffboardingEmployeeList(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
class DashboardTaskListview(SolichListView):
    """
...
if apps.is_installed("asset"):
    ...
    class DashboardNotReturndAsssets(SolichListView):
        """
        For dashboard task status table
        """
        ...
        def __init__(self, *args, **kwargs):
            AssetAssignment = get_solich_model_class(
...
if apps.is_installed("pms"):
    ...
    class DashboardFeedbackView(SolichListView):
        """
        For dashboard task status table
        """
        ...
        def __init__(self, *args, **kwargs):
            self.Feedback = get_solich_model_class(app_label="pms", model="feedback")
