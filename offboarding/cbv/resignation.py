...
class ResignationListView(SolichListView):
    """
    list view
    """
...
class ResinationLettersNav(SolichNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class ResignationLettersFormView(SolichFormView):
    """
...
class ResignationLetterDetailView(SolichDetailedView):
    """
