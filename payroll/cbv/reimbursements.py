...
@method_decorator(login_required, name="dispatch")
class ReimbursementsAndEncashmentsTabView(SolichTabView):
    """
    Tab View
    """
...
@method_decorator(login_required, name="dispatch")
class ReimbursementsAndEncashmentsListView(SolichListView):
    """
    list view
    """
...
@method_decorator(login_required, name="dispatch")
class ReimbursementsNav(SolichNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class ReimbursementsDetailView(SolichDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class ReimbursementsFormView(SolichFormView):
    """
