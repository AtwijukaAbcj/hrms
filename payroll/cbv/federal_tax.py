...
class FederalTaxFormView(SolichFormView):
    """
...
class FilingStatusDetailView(SolichDetailedView):
    """
...
class TaxBracketCreateForm(SolichFormView):
    """
...
class TaxBracketNavView(SolichNavView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("payroll.view_taxbracket"), name="dispatch")
class TaxBracketListView(SolichListView):
    """
