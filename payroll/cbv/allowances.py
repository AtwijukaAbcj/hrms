...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="payroll.view_allowance"), name="dispatch")
class AllowanceListView(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="payroll.view_allowance"), name="dispatch")
class AllowanceNavView(SolichNavView):
    """
    nav bar of the page
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="payroll.view_allowance"), name="dispatch")
class AllowancesCardView(SolichCardView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="payroll.view_allowance"), name="dispatch")
class AllowanceDetailView(SolichDetailedView):
    """
