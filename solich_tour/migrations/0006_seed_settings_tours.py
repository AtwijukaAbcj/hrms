...
TOURS = [
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "steps": [
            ...
            },
            {
                "sequence": 3,
                "title": "Company first",
                "description": "Start with your company profile — name, logo, address and contact details. Everything in Solich is scoped to a company, so this must exist before anything else.",
                "element_selector": "",
                "side": "over",
                "align": "start",
            },
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "title": "Company Setup",
        "description": "How to add and configure your company profile in Solich.",
        ...
        "steps": [
            {
                ...
                "description": "This page lists all companies registered in Solich. Every employee, leave policy, payroll run and setting is scoped to a company — so you need at least one before you can do anything else.",
                "element_selector": "",
                "side": "over",
                "align": "start",
            },
            ...
            },
            {
                ...
                "description": "Solich supports multiple companies in a single instance. Each company has its own employees, leave balances, payroll and reports — fully isolated from each other.",
                "element_selector": "",
                "side": "over",
                "align": "start",
            },
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "steps": [
            ...
            },
            {
                ...
                "description": "Click Create and give the work type a name. Solich comes with common defaults — add any custom types your company uses.",
                "element_selector": "",
                "side": "over",
                "align": "start",
            },
    ...
    # -------------------------------------------------------------------------
    {
        ...
        "steps": [
            ...
            },
            {
                ...
                "description": "If employees rotate through different shifts (morning one week, evening the next), use the Rotating Shift feature to define the rotation schedule — Solich will automatically assign the correct shift each period.",
                "element_selector": "",
                "side": "over",
                "align": "start",
            },
...
def seed(apps, schema_editor):
    Tour = apps.get_model("solich_tour", "Tour")
    TourStep = apps.get_model("solich_tour", "TourStep")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("solich_tour", "0005_fix_sidebar_step_selectors"),
    ]
