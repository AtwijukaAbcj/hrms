    ...
    # -------------------------------------------------------------------------
    {
        ...
        "steps": [
            ...
            },
            {
                "sequence": 5,
                "title": "Run payroll",
                "description": "Generate payslips for a pay period in one click — Solich calculates gross pay, deductions and net pay automatically.",
                "element_selector": "",
                "side": "over",
                "align": "start",
            },
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("solich_tour", "0003_seed_dashboard_highlights_tour"),
    ]
