...
STEPS = {
    ...
    "settings-company": [
        (
            1,
            "Company Settings",
            "This is the Company page. Everything in Solich — employees, leave, payroll — is scoped to a company, so you must create one first.",
            "",
            "over",
            "start",
        ),
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("solich_tour", "0006_seed_settings_tours"),
    ]
