"""
Tests for the solich_tour engine.
...
from solich.solich_middlewares import set_selected_company
...
class TourPermissionTests(TestCase):
    def setUp(self):
        self.client = Client()
        self.regular = SolichUser.objects.create_user(
...
class TourCompanyIsolationTests(TestCase):
    def setUp(self):
        ...
        # SolichModel.save() doesn't stamp modified_by with a stale user id.
