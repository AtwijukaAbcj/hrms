...
class Tour(SolichModel):
    ...
    def get_update_url(self):
        """Edit URL — consumed by SolichListView row actions."""
...
class TourStep(SolichModel):
    ...
    objects = SolichCompanyManager("tour__company_id")
...
class TourProgress(SolichModel):
