"""Solich API JWT login and auth-gate smoke tests."""
...
from solich.testkit import make_company, make_employee, make_user
...
class RejectBasicAuthTests(TestCase):
    def test_reject_basic_authentication_class(self):
        ...
        from solich_api.auth import RejectBasicAuthentication
