# Solich API Documentation

This document provides information on how to use and maintain the API documentation for Solich HRMS.
...
```python
from solich_api.docs import document_api
...
- Module tags are defined in `solich_api/docs.py`
...
- Ensure the URL is included in the `patterns` list in `solich_api/urls.py`
