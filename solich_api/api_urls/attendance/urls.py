"""
solich_api/urls/attendance/urls.py
"""

from django.urls import path

from solich_api.api_views.attendance.permission_views import AttendancePermissionCheck
from solich_api.api_views.attendance.views import *
