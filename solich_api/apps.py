...
class SolichApiConfig(AppConfig):
    ...
    def ready(self):
        ...
        urlpatterns.append(
            path("api/", include("solich_api.urls")),
        )
    ...
    def _configure_swagger_settings(self):
        ...
        swagger_config = {
            ...
            "DEFAULT_SCHEMA_CLASS": "solich_api.schema.ModuleTaggingAutoSchema",
        }
