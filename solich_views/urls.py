...
from solich_views.generic.cbv import history
...
urlpatterns = [
    ...
    path(
        "generic-delete/",
        views.SolichDeleteConfirmationView.as_view(),
        name="generic-delete",
    ),
    path(
        "solich-history-revert/<int:pk>/<int:history_id>/",
        history.SolichHistoryView.as_view(),
        name="history-revert",
    ),
    path(
