...
from solich.decorators import login_required as func_login_required
from solich.http.response import SolichRedirect
from solich.signals import post_generic_delete, pre_generic_delete
...
from solich_views.forms import SavedFilterForm
from solich_views.generic.cbv.views import SolichFormView, SolichListView
...
class ReloadField(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        model: models.SolichModel = dynamic_cache["model"]
...
@method_decorator(login_required, name="dispatch")
class SavedFilter(SolichFormView):
    """
    SavedFilter
    """
...
@method_decorator(login_required, name="dispatch")
class DynamiListView(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
class SolichDeleteConfirmationView(View):
    """
    ...
    def post(self, *args, **kwargs):
        ...
        return SolichFormView.HttpResponse(script=script)
...
def export_data(request, *args, **kwargs):
    ...
    model_path = request.GET.get("model")
    if not model_path:
        return SolichRedirect(request, message=_("No matching query found."))
