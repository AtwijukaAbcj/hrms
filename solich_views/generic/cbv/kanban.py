"""
solich_views/generic/cbv/kanban.py
"""

from django.core.paginator import EmptyPage, PageNotAnInteger, Paginator
from django.db import models

from solich_views.cbv_methods import get_nested_field
from solich_views.generic.cbv.views import SolichCardView


class SolichKanbanView(SolichCardView):
    group_key: str = ""
    group_filter_class = None
    template_name: str = "generic/solich_kanban_view.html"
    kanban_attrs: str = ""
