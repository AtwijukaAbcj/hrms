"""
solich_views/generic/cbv/history.py
"""
...
from solich_views.history_methods import get_diff


@method_decorator(login_required, name="dispatch")
@method_decorator(hx_request_required, name="dispatch")
class SolichHistoryView(DetailView):
    """
    GenericSolichHistoryView
    """

    template_name = "generic/solich_history_view.html"
    ...
    def get_context_data(self, **kwargs):
        ...
        elif hasattr(instance, "solich_history"):
            context["tracking"] = None
            context["log_entries"] = instance.solich_history.all().order_by(
                "-timestamp"
            )
        else:
            context["tracking"] = tracking
