...
@method_decorator(login_required, name="dispatch")
class DisciplinaryActionsList(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
class DisciplinaryActionsNav(SolichNavView):
    """
    For nav bar
    """
...
class DynamicActionTypeFormView(SolichFormView):
...
class DisciplinaryActionsFormView(SolichFormView):
    """
    Form View
    """
...
class DisciplinaryActionsFormDuplicate(SolichFormView):
    """
    Duplicate form view
    """
...
@method_decorator(login_required, name="dispatch")
class DisciplinaryActionsDetailView(SolichDetailedView):
    """
    detail view of page
    """
