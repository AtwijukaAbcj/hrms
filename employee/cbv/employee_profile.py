...
from solich_views.generic.cbv.views import SolichDetailedView, SolichProfileView

Employee.cbv_employee_profile_edi_url = reverse_lazy("edit-profile")


@method_decorator(login_required, name="dispatch")
class EmployeeProfileView(SolichProfileView):
    """
    EmployeeProfileView
    """
...
class EmployeeRelatedDetailView(SolichDetailedView):
    """
