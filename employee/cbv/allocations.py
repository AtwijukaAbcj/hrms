...
class AllocationView(SolichDetailedView):
    """
    AllocationView
    """
...
class PersonalFormView(SolichFormView):
    """
    PersonalFormView
    """
...
class WorkFormView(SolichFormView):
    """
    WorkFormView
    """
...
class BankFormView(SolichFormView):
    """
    WorkFormView
    """
...
if app_installed("asset"):
    ...
    class AssetAllocationList(SolichListView):
        """
    ...
    class AssetCategoryAllocationList(SolichListView):
        """
...
class Summary(TemplateView):
    ...
    def get(self, request, *args, **kwargs):
        ...
        if not instance_id:
            return SolichRedirect(request, message=_("Employee ID missing."))
