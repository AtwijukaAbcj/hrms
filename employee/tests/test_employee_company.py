...
from solich.testkit import CompanyFilterTestMixin, make_company, make_employee
...
class EmployeeCreateTests(TestCase):
    def test_create_employee_creates_user_and_work_info(self):
        ...
        self.assertEqual(emp.employee_user_id.email, "newhire@test.solich")
