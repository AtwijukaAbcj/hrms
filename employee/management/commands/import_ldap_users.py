    ...
    def handle(self, *args, **kwargs):
        try:
            ...
            for dn, entry in results:
                ...
                # Retrieve the associated SolichUser if it exists
                try:
                    user = SolichUser.objects.get(
                    ...
                    user.save()  # Save the changes to the SolichUser instance
                    action = "Updated"
                except SolichUser.DoesNotExist:
