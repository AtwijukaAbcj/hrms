...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_assetlot"), name="dispatch")
class AssetBatchNoListView(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_assetlot"), name="dispatch")
class AssetBatchNoNav(SolichNavView):
    """
    Nav bar
    """
...
class AssetBatchCreateFormView(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_assetlot"), name="dispatch")
class AssetBatchDetailView(SolichDetailedView):
    """
