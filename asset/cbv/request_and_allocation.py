...
@method_decorator(login_required, name="dispatch")
class AllocationList(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
class AssetRequestList(SolichListView):
    """
    Asset Request Tab
    """
...
@method_decorator(login_required, name="dispatch")
class RequestAndAllocationTab(SolichTabView):
    """
    Tab View
    """
...
@method_decorator(login_required, name="dispatch")
class RequestAndAllocationNav(SolichNavView):
    """
    Nav bar
    """
...
class AssetDetailView(SolichDetailedView):
    """
...
class AssetRequestDetailView(SolichDetailedView):
    """
...
class AssetAllocationDetailView(SolichDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class AssetRequestCreateForm(SolichFormView):
    """
...
class AssetAllocationFormView(SolichFormView):
    """
...
class AssetApproveFormView(SolichFormView):
    """
    Create Asset Allocation
    """
...
class AssetRenewalNav(SolichNavView):
    """
...
class ExpiringAssignmentList(SolichListView):
    """
...
class AssetReassignFormView(SolichFormView):
    """
