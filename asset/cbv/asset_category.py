...
from solich_views.generic.cbv.views import SolichFormView, SolichNavView
from solich_views.views import SolichDeleteConfirmationView


@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_assetcategory"), name="dispatch")
class AssetCategoryFormView(SolichFormView):
    """
...
class AssetFormView(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_assetcategory"), name="dispatch")
class AssetCategoryDuplicateFormView(SolichFormView):
    """
...
class AssetDuplicateFormView(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class AssetReportFormView(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("asset.view_asset"), name="dispatch")
class AssetCategoryNav(SolichNavView):
    """
...
class AssetDeleteConfirmationView(SolichDeleteConfirmationView):
    ...
    def post(self, *args, **kwargs):
        ...
        return SolichFormView.HttpResponse(targets_to_reload=[".filterButton"])
