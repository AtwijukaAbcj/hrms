...
from solich.decorators import check_integration_enabled
...
class CredentialListView(SolichListView):
    """
...
@method_decorator(check_integration_enabled(app_name="whatsapp"), name="dispatch")
class CredentialNav(SolichNavView):
    """
...
@method_decorator(check_integration_enabled(app_name="whatsapp"), name="dispatch")
class CredentialForm(SolichFormView):
    """
