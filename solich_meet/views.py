...
from solich_meet.methods import get_google_credentials
from solich_meet.models import *
...
@login_required
@permission_required("solich_meet.delete_googlecloudcredentials")
...
@login_required
@permission_required("solich_meet.add_googlemeeting")
@check_integration_enabled(app_name="solich_meet")
...
@login_required
@permission_required("solich_meet.delete_googlemeeting")
@check_integration_enabled(app_name="solich_meet")
