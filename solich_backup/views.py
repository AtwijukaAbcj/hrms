...
# @login_required
# @permission_required("solich_backup.add_localbackup")
...
# @login_required
# @permission_required("solich_backup.change_localbackup")
...
# @login_required
# @permission_required("solich_backup.delete_localbackup")
