...
from solich.methods import remove_dynamic_url
...
def validate_bulk_attendance(request):
    ...
    for obj_id in filtered_ids:
        try:
            ...
            # Fixes: https://github.com/solich/solich-hr/issues/1055
            if (
...
def work_record_export(request):
    ...
    format_string = settings.SOLICH_DATE_FORMATS.get(date_format)
