...
def build_monthly_summary(from_date, to_date, employee_qs):
    ...
    # GROUP BY join-multiplication caused by SolichCompanyManager's work-info
    # join.
...
def attendance_monthly_summary_table(request):
    ...
    # Sorting — mirrors the outcome of SolichListView's sortby() (query
    ...
    # (like SolichListView leaves some columns out of its sortby_mapping)
    ...
    # Same convention as SolichListView.select_all(): every pk matching the
