...
@method_decorator(login_required, name="dispatch")
class AttendancesRequestTabView(SolichTabView):
    """
...
@method_decorator(login_required, name="dispatch")
class AttendancesRequestListView(SolichListView):
    """
    list view
    """
...
def _request_tab_badge_count(request, view_cls):
    """Same queryset rules as the tab's SolichListView (filters, subordinates)."""
    view = view_cls()
...
@method_decorator(login_required, name="dispatch")
class AttendanceRequestNav(SolichNavView):
    """
    nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class AttendanceListTabDetailView(SolichDetailedView):
    """
    Detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class NewAttendanceRequestFormView(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class BulkAttendanceRequestFormView(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class UpdateAttendanceRequestFormView(SolichFormView):
    """
