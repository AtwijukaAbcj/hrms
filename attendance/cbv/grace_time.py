...
class GenericGraceTimeListView(SolichListView):
    """
...
class DefaultGraceTimeNav(SolichNavView):
    """
    Nav bar
    """
...
class GraceTimeNav(SolichNavView):
    """
    Nav bar
    """
...
class GraceTimeFormView(SolichFormView):
    """
