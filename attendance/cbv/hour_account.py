...
@method_decorator(login_required, name="dispatch")
class HourAccountList(SolichListView):
    """
    List view
    """
...
@method_decorator(login_required, name="dispatch")
class HourAccountNav(SolichNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class HourAccountDetailView(SolichDetailedView):
    """
    Detail View
    """
...
class HourAccountFormView(SolichFormView):
    """
    Form View
    """
