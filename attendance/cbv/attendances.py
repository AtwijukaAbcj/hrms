...
@method_decorator(login_required, name="dispatch")
class AttendancesListView(SolichListView):
    """
    list view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("attendance.view_attendance"), name="dispatch")
class AttendancesTabView(SolichTabView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("attendance.view_attendance"), name="dispatch")
class AttendancesNavView(SolichNavView):
    """
    nav bar
    """
...
def _badge_count_from_attendance_list_view(request, view_cls):
    """
    Use the same queryset rules as each tab's SolichListView (filters, subordinates).
    """
    view = view_cls()
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("attendance.view_attendance"), name="dispatch")
class GenericAttendancesDetailView(SolichDetailedView):
    """
...
class AttendancesFormView(SolichFormView):
    """
    form view
    """
...
class AttendanceUpdateFormView(SolichFormView):
    """
    form for update
    """
...
@method_decorator(login_required, name="dispatch")
class PenaltyAccountListView(SolichListView):
    """
