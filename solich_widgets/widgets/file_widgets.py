...
Solich shows a clean display name instead of solich.models.upload_path's
...
def patch_clearable_file_input():
    ...
    point its template at the Solich override.
    """
    ...
    forms.ClearableFileInput.template_name = (
        "solich_widgets/solich_clearable_file_input.html"
    )
