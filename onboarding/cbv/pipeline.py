...
class PipelineNav(SolichNavView):
    """
    SolichNavView
    """
...
class RecruitmentTabView(SolichTabView):
    """
    RecruitmentTabView
    """
...
class CandidateList(SolichListView):
    """
    CandidateList
    """
...
@method_decorator(login_required, name="dispatch")
class CandidateKanbanView(SolichKanbanView):
    """
    CandidateKanbanView
    """
...
class ChangeStage(SolichFormView):
    """
