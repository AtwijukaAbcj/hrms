...
class StageCreateForm(SolichFormView):
    """
...
class TaskCreateForm(SolichFormView):
    """
...
class TaskUpdateFormView(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class OnboardingCandidateDetailView(SolichDetailedView):
    """
