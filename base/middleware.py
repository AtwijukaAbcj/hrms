...
from solich.solich_middlewares import _thread_locals, set_selected_company
from solich.methods import get_solich_model_class
from solich_documents.models import DocumentRequest

CACHE_KEY = "solich_company_models_cache_key"
...
#         is_solich_manager = isinstance(model.objects, SolichCompanyManager)
...
#             elif is_solich_manager and related_company_field:
#                 model.add_to_class(
...
#                         [get_solich_model_class(app_label, model) for model in models]
#                     )
