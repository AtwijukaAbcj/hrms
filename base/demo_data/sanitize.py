...
def sanitize_loaded_records() -> dict[str, int]:
    ...
    if apps.is_installed("project"):
        ...
        for project in Project.objects.filter(
            Q(title__icontains="Solich")
            | Q(description__icontains="Solich")
            | Q(title__icontains="Odoo")
        ):
    ...
    if apps.is_installed("pms"):
        ...
        try:
            ...
            for meeting in Meetings.objects.filter(title__icontains="Solich"):
        ...
        try:
            ...
            for model in (Objective, EmployeeObjective):
                for obj in model.objects.filter(
                    Q(title__icontains="Solich") | Q(title__icontains="Odoo")
                ):
