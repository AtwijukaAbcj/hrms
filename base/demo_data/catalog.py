...
STRING_REPLACEMENTS: list[tuple[str, str]] = [
    ...
    ("Solich Next Inc.", "Your Company"),
    ("Solich OpenSource HRMS", "Enterprise HR Platform"),
    ("Solich Family Day", "Company Family Day"),
    ("Solich Technical Meeting", "Engineering Sync"),
