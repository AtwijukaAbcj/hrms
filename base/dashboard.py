...
def _resolve_checklist_company(request):
    ...
    """
    from solich.solich_middlewares import get_selected_company
...
def _exists_for_company(ModelClass, company_id):
    ...
    company.  Mirrors SolichCompanyManager: a record is visible when it is
...
def _get_setup_checklist_context(request):
    ...
    steps = [
        ...
        },
        {
            ...
            "title": _("Mail Server"),
            "description": _(
                "Configure an outgoing mail server so Solich can send emails."
            ),
