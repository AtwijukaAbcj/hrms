...
from solich_views.cbv_methods import login_required, permission_required
from solich_views.generic.cbv.views import SolichFormView, SolichNavView


@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("base.add_solichmailtemplate"), name="dispatch")
class MailTemplateFormView(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("base.add_solichmailtemplate"), name="dispatch")
class MailTemplateDuplicateForm(SolichFormView):
    """
    ...
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        original_object = SolichMailTemplate.objects.get(id=self.kwargs["pk"])
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required("base.view_solichmailtemplate"), name="dispatch")
class MailTemplateNavView(SolichNavView):
    """
