...
@method_decorator(login_required, name="dispatch")
class GeneralParent(SolichListView):
    """
...
class RotatingWorkNavView(SolichNavView):
    """
...
class RotatingWorkDetailView(SolichDetailedView):
    """
    Detail view of page
    """
...
class RotatingWorkTypeFormView(SolichFormView):
    """
    form view
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("base.add_rotatingworktypeassign"), name="dispatch")
class RotatingWorkTypeDuplicateForm(SolichFormView):
    """
    duplicate from view
    """
