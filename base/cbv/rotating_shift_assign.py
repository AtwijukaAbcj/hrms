...
@method_decorator(login_required, name="dispatch")
class RotatingShiftListParent(SolichListView):
    """
    Parent class
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("base.view_rotatingshiftassign"), name="dispatch")
class RotatingShiftAssignNav(SolichNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("base.view_rotatingshiftassign"), name="dispatch")
class RotatingShiftDetailview(SolichDetailedView):
    """
    Detail View
    """
...
class RotatingShiftFormView(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(manager_can_enter("base.view_rotatingshiftassign"), name="dispatch")
class RotatingShiftAssignDuplicate(SolichFormView):
    """
    Duplicate form view
    """
