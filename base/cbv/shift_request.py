...
@method_decorator(login_required, name="dispatch")
class ShiftList(SolichListView):
    """
    List view
    """
...
@method_decorator(login_required, name="dispatch")
class ShitRequestNav(SolichNavView):
    """
    Nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftRequestTab(SolichTabView):
    """
    Tab View
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftRequestDetailview(SolichDetailedView):
    """
    Detail View
    """
...
class ShiftTypeFormView(SolichFormView):
    """
    form view
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftRequestFormView(SolichFormView):
    """
    Form View
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftRequestFormDuplicate(SolichFormView):
    """
    Duplicate form view
    """
...
@method_decorator(login_required, name="dispatch")
class ShiftAllocationFormView(SolichFormView):
    """
    Form View
    """
