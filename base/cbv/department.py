...
class DepartmentListView(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="base.view_department"), name="dispatch")
class DepartmentNavView(SolichNavView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="base.view_department"), name="dispatch")
class DepartmentDetailView(SolichDetailedView):
    """
...
class DepartmentCreateForm(SolichFormView):
    """
