...
class JobPositionListView(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="base.view_jobposition"), name="dispatch")
class JobPositionNavView(SolichNavView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="base.view_jobposition"), name="dispatch")
class JobPositionDetailView(SolichDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="base.view_jobposition"), name="dispatch")
class JobPositionCreateForm(SolichFormView):
    """
