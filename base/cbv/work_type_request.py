...
@method_decorator(login_required, name="dispatch")
class WorkRequestListView(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
class WorkRequestNavView(SolichNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class WorkTypeDetailView(SolichDetailedView):
    """
    Detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class DynamicWorkTypeCreateForm(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class WorkTypeFormView(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class WorkTypeDuplicateForm(SolichFormView):
    """
    duplicate form
    """
