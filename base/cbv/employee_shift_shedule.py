...
class EmployeeShiftSheduleNav(SolichNavView):
    """
...
class EmployeeShiftSheduleCreateForm(SolichFormView):
    """
...
class EmployeeShiftSheduleList(SolichListView):
...
@method_decorator(login_required, name="dispatch")
class EmployeeShiftSheduleDetailView(SolichDetailedView):
    """
