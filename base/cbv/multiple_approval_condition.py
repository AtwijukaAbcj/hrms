...
class MultipleApprovalConditionList(SolichListView):
    """
...
class MultipleApprovalConditionNav(SolichNavView):
    """
    Nav bar
    """
...
class MultipleApprovalConditionDetailView(SolichDetailedView):
    """
    detail view of page
    """
...
@method_decorator(login_required, name="dispatch")
class MultipleApprovalConditionFormView(SolichFormView):
    """
