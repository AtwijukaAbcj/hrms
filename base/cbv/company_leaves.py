...
@method_decorator(login_required, name="dispatch")
class CompanyleaveListView(SolichListView):
    """
    list view
    """
...
@method_decorator(login_required, name="dispatch")
class CompanyLeaveNavView(SolichNavView):
    """
    nav bar
    """
...
@method_decorator(login_required, name="dispatch")
class CompanyLeaveDetailView(SolichDetailedView):
    """
...
@method_decorator(login_required, name="dispatch")
class CompanyleaveFormView(SolichFormView):
    """
