...
class DashboardWorkTypeRequest(WorkRequestListView):
    ...
    def get_queryset(self):
        ...
        queryset = SolichListView.get_queryset(self)
...
class EmployeeWorkInformationList(SolichListView):
    """
...
class EmployeeWorkInformationFormView(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class DashboardAnnouncementView(SolichListView):
    """
...
class AnnouncementViewedByList(SolichListView):
    """
