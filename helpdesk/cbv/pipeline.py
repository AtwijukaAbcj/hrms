...
class TicketPipelineView(SolichSectionView):
    """
...
@method_decorator(login_required, name="dispatch")
class TicketPipelineNav(SolichNavView):
    """
...
@method_decorator(login_required, name="dispatch")
class TicketTabView(SolichTabView):
    """
    Pipeline List View
    """
...
@method_decorator(login_required, name="dispatch")
class TicketListView(SolichListView):
    """
    Pipeline List View
    """
...
@method_decorator(login_required, name="dispatch")
class TicketCardView(SolichKanbanView):
    model = Ticket
    filter_class = TicketFilter
    group_key = "status"
    records_per_page = 10
