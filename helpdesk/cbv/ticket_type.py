...
class TicketsListView(SolichListView):
    """
...
@method_decorator(login_required, name="dispatch")
@method_decorator(permission_required(perm="helpdesk.view_tickettype"), name="dispatch")
class TicketsNavView(SolichNavView):
    """
...
class TicketTypeCreateForm(SolichFormView):
    """
...
@method_decorator(login_required, name="dispatch")
class TicketsCreateFormView(SolichFormView):
    """
